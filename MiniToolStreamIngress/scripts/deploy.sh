...
# Deploy MiniToolStreamIngress to k3s
...
echo -e "${BLUE}=== MiniToolStreamIngress Deployment ===${NC}"
...
echo ""
kubectl get svc -n minitoolstream -l app=minitoolstream-ingress

echo -e "${GREEN}Deployment successful!${NC}"
echo ""
echo "To check logs: kubectl logs -f -n minitoolstream -l app=minitoolstream-ingress"
echo "To check status: kubectl get pods -n minitoolstream -l app=minitoolstream-ingress"
